...
This repository is the public documentation, support, issue-tracking, and feedback home for **ExcelXtreme 1.0**.
...
|---|---|
| Product version | `1.0` or the exact version you are using |
| Host | Microsoft Excel plus the exact Office/Windows version where relevant |
...
**Current release: 1.0.** Use this repository for documentation, compatibility notes, issue tracking, and product feedback.
...
| Destination | Link |
|---|---|
| Product support | [ExcelXtreme-Support](https://github.com/pacosalasv/ExcelXtreme-Support) |
